...
$query ='SELECT `id`, `tit`, `img`,`des`, `content`, `create_time`, `create_mem`, `edit_time`, `edit_mem`, `status`, `rank` FROM `news`';
$paras=[];
    ...
    <table id="tb-post">
        <tbody>
            ...
            <tr>
                ...
                <td><a href=""><img style="min-height:100px;width:auto;" src="<?php echo '../'.NEWS_PATH.$post['img'].'?'.rand();?>" alt=""></a></td>
                ...
                <td>
                    <button data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Edit" onclick="window.location.href='post.php?id=<?php echo $post['id'];?>'"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                </td>
            </tr>
            <?php
                }
